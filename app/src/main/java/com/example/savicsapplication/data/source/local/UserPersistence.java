...
public class UserPersistence {
    private static UserPersistence ourInstance;

    private static final String SETTINGS_NAME = "com.savics.sharedPrefs";
    ...
    public static UserPersistence getInstance(Context context) {
        if (ourInstance == null && context != null) {
            ourInstance = new UserPersistence(context.getApplicationContext());
        }
        return ourInstance;
    }
